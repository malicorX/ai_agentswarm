# Phase 21 close-out: staging bundle + news pipeline polish (P21.11).
...
Write-Host "Phase 21 close-out checks OK. Tag with:"
Write-Host "  git tag v0.22.0-phase21 && git push origin v0.22.0-phase21"
