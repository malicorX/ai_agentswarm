# Phase 10 close-out: lease reclaim + isolated subjective verify on staging (P10.11).
...
Write-Host "Phase 10 close-out checks OK. Tag with:"
Write-Host "  git tag v0.11.0-phase10 && git push origin v0.11.0-phase10"
