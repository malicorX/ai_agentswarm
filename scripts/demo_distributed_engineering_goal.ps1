# Distributed engineering goal: sparky1 + sparky2 + local against staging.
param(
    [switch]$SyncRemotes,
...
function Sync-RemoteRepo {
    ...
    scp scripts/demo_volunteer_subjective.py scripts/run_volunteer_role.py scripts/demo_distributed_volunteers.py scripts/demo_engineering_goal.py scripts/demo_distributed_engineering_goal.py "${RemoteHost}:${DistRepo}/scripts/"
...
python scripts/demo_distributed_engineering_goal.py --base-url $ApiUrl @args
exit $LASTEXITCODE
