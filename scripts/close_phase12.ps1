# Phase 12 close-out: automatic redispatch after lease reclaim on staging (P12.11).
...
Write-Host "Phase 12 close-out checks OK. Tag with:"
Write-Host "  git tag v0.13.0-phase12 && git push origin v0.13.0-phase12"
