# Phase 11 close-out: lease reclaim observability on staging (P11.11).
...
Write-Host "Phase 11 close-out checks OK. Tag with:"
Write-Host "  git tag v0.12.0-phase11 && git push origin v0.12.0-phase11"
