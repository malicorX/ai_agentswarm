...
3. ~~**Minimum hardware bar** for reviewers (VRAM).~~ — **Pilot guidance:** [volunteer-hardware.md](docs/volunteer-hardware.md) (P7.6); **server-side gates:** optional `AGENTSWARM_HARDWARE_GATES_ENFORCE=1` (P9.1) filters reviewer dispatch by self-reported `vram_gb`.
